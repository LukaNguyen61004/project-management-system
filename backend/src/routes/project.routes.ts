...
import {
        createProjectController, getUserProjectsController, getProjectDetailController,
        ...
        deleteProjectController, getMyPendingInvitationsController, declineInvitationController
...
router.get('/invitations/pending', authMiddleware, getMyPendingInvitationsController);

router.post('/invitations/decline', authMiddleware, declineInvitationController);
